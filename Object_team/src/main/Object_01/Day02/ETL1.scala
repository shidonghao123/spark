...
object ETL1 {
  def main(args: Array[String]): Unit = {
    ...
    val value: RDD[( String, (Int, Int, Int, Int, Int, Int, Int, Int, Int))] = file.map(x => {
      ...
      var buss=x(27).toString
      if(buss=="未知"){ buss = "其他"}else{buss}
      var num1 = 0
      var num2 = 0
      var num3 = 0
      var num4 = 0
      ...
      (buss, (num1, num2, num3, num4, num5, num6, num7, num8, num9))
    })
    ...
    }).sortBy(_._1).toDF("运营商", "原始请求", "有效请求", "广告请求", "参与竞价数", "竞价成功数", "竞价成功率", "展示量", "点击量", "点击率", "广告成本", "广告消费")
    DFres.show()
